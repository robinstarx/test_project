          ...
          {projects.map((project, index) => (
            ...
            >
              <Card3D className="h-full">
                <div className="group relative h-full glass rounded-3xl overflow-hidden backdrop-blur-xl hover:bg-white/5 transition-all duration-500 flex flex-col">
                  {/* Project Image */}
                  ...
                  <div className="p-6 space-y-4 flex-grow flex flex-col">
                    ...
                    {/* Description */}
                    <p className="text-gray-400 leading-relaxed line-clamp-4 flex-grow">
                      {project.description}
                    </p>
